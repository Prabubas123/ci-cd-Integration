...
import getRelatedContactByFilter from '@salesforce/apex/ContactController.getRelatedContactByFilter';
...
export default class RelatedContactsWithFilter extends LightningElement {
    ...
    loadRelatedContacts(filterKey){
        getRelatedContactByFilter({accountId : this.recordId, key : filterKey})
        .then(results=>{
            this.data=results;
        })
        .catch(error=>{
